...
(0, config_1.task)(exports.TASK_STARKNET_COMPILE)
    ...
    const compileJobs = await hre.run(exports.TASK_STARKNET_COMPILE_GET_FILES_TO_COMPILE, { sources: cairoFiles, cache: cairoFilesCache });
    if (compileJobs.length > 0) {
        try {
            await hre.run(exports.TASK_STARKNET_COMPILE_COMPILE, { compileJobs: compileJobs, cache: cairoFilesCache });
        }
        finally {
